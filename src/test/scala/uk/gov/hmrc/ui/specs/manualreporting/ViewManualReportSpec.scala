...
class ViewManualReportSpec extends SubmissionBaseSpec {
  ...
  Feature("View New Assumed Report") {
    ignore("Single Platform Operator with correct data - View Manual Assumed Report") {
    ...
    Scenario("Single Platform Operator with correct data - Edit Manual Assumed Report") {
      ...
      And("Change registered address country is clicked")
      CheckYourAnswersAssumedReportPage(platformOperatorId, reportingPeriod).clickChangeRegisteredAddressCountry()
      ChangeRegisteredAddressCountryPage(platformOperatorId, reportingPeriod).withCountry("Nepal").continue()
      ...
      And("Change tax resident country is clicked")
      CheckYourAnswersAssumedReportPage(platformOperatorId, reportingPeriod).clickChangeTaxResidentCountry()
      ChangeTaxResidencyCountryPage(platformOperatorId, reportingPeriod).withCountry("Nepal").continue()
