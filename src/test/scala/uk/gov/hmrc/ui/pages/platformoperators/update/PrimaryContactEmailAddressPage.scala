...
case class PrimaryContactEmailAddressPage(platformOperatorId: String)
    extends OperatorBasePage(s"/platform-operator/$platformOperatorId/change-email-address") {
