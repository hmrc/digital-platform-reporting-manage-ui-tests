...
case class SecondaryContactNamePage(platformOperatorId: String)
    extends OperatorBasePage(s"/platform-operator/$platformOperatorId/change-second-contact-name") {
