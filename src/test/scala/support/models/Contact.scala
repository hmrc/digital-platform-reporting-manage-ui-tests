...
final case class IndividualContact(individual: Individual, email: String, phone: Option[String]) extends Contact
...
final case class OrganisationContact(organisation: Organisation, email: String, phone: Option[String]) extends Contact
